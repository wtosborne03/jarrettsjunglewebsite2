...
(function ($) {
  ...
  $.fn.googlePlaces = function (options) {
    ...
    var renderPicture = function (picture, purl) {
      //return "<a href='" + purl + "'><img class='review-picture' src='" + picture + "'></a>";
      return "";
    }
    ...
    var renderReviews = function (reviews) {
      ...
      for (var i = rowCount; i >= 0; i--) {
        ...
        if (settings.showProfilePicture) {
          picture = renderPicture(review.profile_photo_url, review.author_url);
        }
        ...
        html = html + "<div id='re" + i + "' class=" + style + "><div class='review-header'>" + picture + "<div class='review-usergrade'><div class='review-meta'><a style='color:black' href='" + review.author_url + "'><span class='review-author'>" + name + "</span></a><span class='review-sep'></span>" + "</div>" + stars + "</div></div><p class='review-text'>" + reviewText + "</p></div>";
