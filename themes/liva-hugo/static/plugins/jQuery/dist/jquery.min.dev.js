...
!function (e, t) {
  ...
  var C = function (e) {
    ...
    return ve.prototype = r.filters = r.pseudos, r.setFilters = new ve(), a = oe.tokenize = function (e, t) {
      ...
      if (!v) {
        ...
        (v = S(e, (i = h, o = f, s = o.length > 0, u = i.length > 0, c = function c(e, t, n, a, _c) {
          var f,
              h,
              v,
              y = 0,
          ...
          for (_c && (l = t === d || t || _c); m !== k && null != (f = C[m]); m++) {
            if (u && f) {
  ...
  (b.fn.init = function (e, t, n) {
    ...
    if (n = n || j, "string" == typeof e) {
      ...
      if (i[1]) {
        if (t = t instanceof b ? t[0] : t, b.merge(this, b.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : r, !0)), N.test(i[1]) && b.isPlainObject(t)) for (i in t) {
  ...
  function se(e, t) {
    for (var n, r, i = [], o = 0, a = e.length; o < a; o++) {
      (r = e[o]).style && (n = r.style.display, t ? ("none" === n && (i[o] = Y.get(r, "display") || null, i[o] || (r.style.display = "")), "" === r.style.display && re(r) && (i[o] = (s = r, u = void 0, l = void 0, void 0, f = void 0, l = s.ownerDocument, c = s.nodeName, f = ae[c], f || (u = l.body.appendChild(l.createElement(c)), f = b.css(u, "display"), u.parentNode.removeChild(u), "none" === f && (f = "block"), ae[c] = f, f)))) : "none" !== n && (i[o] = "none", Y.set(r, "display", n)));
    }
  ...
  function ye(e, t, n, r, i) {
    for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) {
      if ((o = e[d]) || 0 === o) if ("object" === x(o)) b.merge(p, o.nodeType ? [o] : o);else if (ve.test(o)) {
        for (a = a || f.appendChild(t.createElement("div")), s = (le.exec(o) || ["", ""])[1].toLowerCase(), u = fe[s] || fe._default, a.innerHTML = u[1] + b.htmlPrefilter(o) + u[2], c = u[0]; c--;) {
          a = a.lastChild;
        }
    ...
    for (f.textContent = "", d = 0; o = p[d++];) {
      if (r && b.inArray(o, r) > -1) i && i.push(o);else if (l = b.contains(o.ownerDocument, o), a = pe(f.appendChild(o), "script"), l && de(a), n) for (c = 0; o = a[c++];) {
  ...
  b.event = {
    ...
    add: function add(e, t, n, r, i) {
      ...
      if (v) for (n.handler && (n = (o = n).handler, i = o.selector), i && b.find.matchesSelector(me, i), n.guid || (n.guid = b.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function (t) {
        ...
        d = g = (s = we.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = b.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = b.event.special[d] || {}, c = b.extend({
          type: d,
          origType: g,
          data: r,
          handler: n,
  ...
  function Oe(e, t, n, r) {
    ...
    if (p && (o = (i = ye(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
      for (u = (s = b.map(pe(i, "script"), qe)).length; f < p; f++) {
        l = i, f !== d && (l = b.clone(l, !0, !0), u && b.merge(s, pe(l, "script"))), n.call(e[f], l, f);
      }

      if (u) for (c = s[s.length - 1].ownerDocument, b.map(s, Le), f = 0; f < u; f++) {
        l = s[f], ce.test(l.type || "") && !Y.access(l, "globalEval") && b.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? b._evalUrl && b._evalUrl(l.src) : m(l.textContent.replace(Ae, ""), c, l));
      }
    }
  ...
  function Pe(e, t, n) {
    for (var r, i = t ? b.filter(t, e) : e, o = 0; null != (r = i[o]); o++) {
      n || 1 !== r.nodeType || b.cleanData(pe(r)), r.parentNode && (n && b.contains(r.ownerDocument, r) && de(pe(r, "script")), r.parentNode.removeChild(r));
    }
  ...
  b.extend({
    ...
    clone: function clone(e, t, n) {
      ...
      if (!(h.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || b.isXMLDoc(e))) for (a = pe(c), r = 0, i = (o = pe(e)).length; r < i; r++) {
        s = o[r], u = a[r], void 0, l = u.nodeName.toLowerCase(), "input" === l && ue.test(s.type) ? u.checked = s.checked : "input" !== l && "textarea" !== l || (u.defaultValue = s.defaultValue);
      }
    ...
    html: function html(e) {
      return F(this, function (e) {
        ...
        if ("string" == typeof e && !De.test(e) && !fe[(le.exec(e) || ["", ""])[1].toLowerCase()]) {
          ...
          try {
            for (; n < r; n++) {
              1 === (t = this[n] || {}).nodeType && (b.cleanData(pe(t, !1)), t.innerHTML = e);
            }
  ...
  function ut(e, t, n) {
    var r,
      ...
      for (var t = Ke || ot(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), o = 0, a = l.tweens.length; o < a; o++) {
        l.tweens[o].run(r);
      }
  ...
  b.Animation = b.extend(ut, {
    ...
    tweener: function tweener(e, t) {
      ...
      for (var n, r = 0, i = e.length; r < i; r++) {
        n = e[r], ut.tweeners[n] = ut.tweeners[n] || [], ut.tweeners[n].unshift(t);
      }
    },
  ...
  b.fn.extend({
    ...
    toggleClass: function toggleClass(e, t) {
      ...
      return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : g(e) ? this.each(function (n) {
        ...
        var t, i, o, a;
        if (r) for (i = 0, o = b(this), a = gt(e); t = a[i++];) {
  ...
  b.extend(b.event, {
    trigger: function trigger(t, n, i, o) {
      ...
      if (s = h = u = i = i || r, 3 !== i.nodeType && 8 !== i.nodeType && !yt.test(m + b.event.triggered) && (m.indexOf(".") > -1 && (m = (x = m.split(".")).shift(), x.sort()), c = m.indexOf(":") < 0 && "on" + m, (t = t[b.expando] ? t : new b.Event(m, "object" == _typeof(t) && t)).isTrigger = o ? 2 : 3, t.namespace = x.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : b.makeArray(n, [t]), d = b.event.special[m] || {}, o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
        if (!o && !d.noBubble && !v(i)) {
          for (l = d.delegateType || m, yt.test(l + m) || (s = s.parentNode); s; s = s.parentNode) {
            y.push(s), u = s;
          }
  ...
  function St(e, t, n, r) {
    ...
    if (Array.isArray(t)) b.each(t, function (t, i) {
      n || Tt.test(e) ? r(e, i) : St(e + "[" + ("object" == _typeof(i) && null != i ? t : "") + "]", i, n, r);
  ...
  b.ajaxSetup({
    ...
    var r,
        ...
        a = this,
        s = e.indexOf(" ");
    return s > -1 && (r = dt(e.slice(s)), e = e.slice(0, s)), g(t) ? (n = t, t = void 0) : t && "object" == _typeof(t) && (i = "POST"), a.length > 0 && b.ajax({
      url: e,
      type: i || "GET",
      dataType: "html",
      data: t
