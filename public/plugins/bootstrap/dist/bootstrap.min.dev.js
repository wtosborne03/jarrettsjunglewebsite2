...
!function (t, e) {
  ...
  for (var x = Math.min, j = Math.round, R = Math.floor, H = Math.max, F = "undefined" != typeof window && "undefined" != typeof document, W = ["Edge", "Trident", "Firefox"], M = 0, U = 0; U < W.length; U += 1) {
  ...
  var s,
    ...
    return e.toggle = function () {
      ...
      return this.each(function () {
        var n = Q(this),
            i = n.data(G),
            r = o({}, X, n.data(), "object" == _typeof(e) && e ? e : {});
    ...
    return e.toggle = function () {
      ...
      return this.each(function () {
        ...
        if (n || (n = new t(this, "object" == _typeof(e) ? e : null), st(this).data(lt, n)), "string" == typeof e) {
    ...
    return e.toggle = function (t) {
      ...
      return this.each(function () {
        var i = xt(this).data(Rt),
            r = o({}, Wt, xt(this).data(), "object" == _typeof(e) && e ? e : {});
    ...
    return e.enable = function () {
      ...
      "object" == _typeof(e) && (e.nodeType || e.jquery) ? n ? zt(e).parent().is(t) || t.empty().append(e) : t.text(zt(e).text()) : t[n ? "html" : "text"](e);
    }, e.getTitle = function () {
      ...
      return "number" == typeof (t = o({}, this.constructor.Default, zt(this.element).data(), "object" == _typeof(t) && t ? t : {})).delay && (t.delay = {
        show: t.delay,
        hide: t.delay
    ...
    return e.refresh = function () {
      ...
      if ("string" != typeof (t = o({}, Le, "object" == _typeof(t) && t ? t : {})).target) {
      ...
      return this.each(function () {
        ...
        if (n || (n = new t(this, "object" == _typeof(e) && e), Ae(this).data(Oe, n)), "string" == typeof e) {
          if (void 0 === n[e]) throw new TypeError('No method named "' + e + '"');
          n[e]();
        }
      });
